...
blynk = BlynkLib.Blynk('Xe7kVPXJR9LqZ8aYzJclLwB9t2aB0daa', server='127.0.0.1', port='8080')
    ...
    if len(trs)==0:
        ...
        if end==1:
            ...
            for _ in range(3):
                rgb = [randint(0,255),randint(0,255),randint(0,255)]
                for q in range(0,4):
                    for j in range(0,0+(q*2)): pixel.setColor(0+q,j+q,rgb); time.sleep(0.05)
                    for i in range(0,1+(q*2)): pixel.setColor(i+q,7-q,rgb); time.sleep(0.05)

                    for j in range(0,1+(q*2)): pixel.setColor(7-q,7-j-q,rgb); time.sleep(0.05)
                    for i in range(0,2+(q*2)): pixel.setColor(7-i-q,0+q,rgb); time.sleep(0.05)
